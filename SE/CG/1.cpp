/*Write C++ program to draw a concave polygon and fill it with the desired color using the scan fill algorithm. */
...
int main() {
    int n, i, j, k, gd = DETECT, gm, x[10], y[10], ymax = 0, ymin = 480, yy,
                    temp;
